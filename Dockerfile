...
# and create a 'runner' user for running the app (instead of root) RUN apk update && \
...
# Micro-service files shall belong to 'runner' user RUN chown -R runner:runner /home/runner/booksCatalog/
